...
/**
 * Slide-out basket. Submitting hands the ticket straight to the order tracker,
 * which is now the single place a customer sees their number, its progress and
 * the option to cancel — so this panel stays about the basket alone.
 */
export function CartSheet() {
  ...
  const { ordersConfig, adoptOrder, openTracker, refresh } = useMyOrders();
      ...
      >
        <div className="flex items-center justify-between border-b border-border px-5 py-4">
          ...
          <button
            type="button"
            onClick={closeCart}
            className="grid h-10 w-10 place-items-center rounded-full text-foreground transition hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          ...
          {lines.length === 0 ? (
            <div className="flex h-full flex-col items-center justify-center gap-2 text-center">
              ...
              <p className="max-w-xs text-sm text-muted-foreground">
                Tap any menu item to choose a size and options, then add it here.
              </p>
            </div>
          ) : (
                  ...
                  <div className="flex shrink-0 flex-col items-end gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="grid h-11 w-11 place-items-center rounded-full border border-border text-foreground transition hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                      ...
                      <button
                        ...
                        className="ml-1 grid h-11 w-11 place-items-center rounded-full text-muted-foreground transition hover:bg-destructive/10 hover:text-destructive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
